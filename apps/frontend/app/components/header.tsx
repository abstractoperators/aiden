...
const baseHeaderStyle = "border-b border-gray-300 sticky flex items-center justify-center top-2 pb-2 z-50 w-full {}";
enum headerStyles {
  ...
  switch (variant) {
    case "landing":
      return {
        ...
        aidenImage: <Image className="w-6 transition duration-300 hover:invert-[.5]" src={LightGhost} alt="AIDEN" />,
      };
    case "main":
    default:
      return {
        headerStyle: headerStyles.main,
        aidenImage: <ThemeImage className="w-6 transition duration-300 hover:invert-[.5]" lightSrc={LightGhost} darkSrc={DarkGhost} alt="AIDEN" />,
      };
  }
}
  ...
  return (
    ...
    >
      <div className="container flex h-14 items-center">
        ...
        <nav className="flex flex-1 items-center justify-between space-x-8 md:justify-end> // text-sm font-medium">
